    ...
    <div class="exec-band">
      ...
      <ul class="exec-points">
        ...
        <li><strong>Deliberate exclusions</strong> from the reference material: higher-education enrolment
          administration, external-workforce cost, and budget-vs-actual position variance — each needs an
          input this schema does not define, and nothing is shown that cannot be computed from declared inputs.</li>
